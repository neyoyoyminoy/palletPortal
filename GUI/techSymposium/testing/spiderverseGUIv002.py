...
import random #for the glitch effect
import string #for letter scrable of the characters
...
import spidev #for the LEDs using SPI
...
class LEDWorker(QThread):
    ...
    to_glitch_flash = pyqtSignal() #for the glitch sync
    ...
    def __init__(self, num_leds=5, parent=None):
        ...
        self.to_glitch_flash.connect(self._start_glitch)
